			...
			<div class="reserve_content">
				<div class="reserve_left" id="reserveMain">
											...
											<div class="radio_group">
												<span class="ng-scope">
													<span class="radio_box_type checked">
														<input type="radio" name="d_method" id="d_method_0" class="ng-pristine ng-untouched ng-valid ng-not-empty" value="SITE">
														<label for="d_method_0" class="ng-binding" style="cursor: default;"> 현장수령 </label>
													</span>
												</span>
											</div>
										</td>
					...
					<div class="reserve_step3 customer_check">
						...
						<ul class="input_block_lst">
							...
							<li>
								<span class="checkbox">
									<input type="checkbox" id="reserve_agree2" name="reserve_agree2">
								</span>
							...
							<li ng-show="reserve.isKboProduct">
								...
								<a href="#" class="btn_link confirm-open2">[상세보기]</a>
							</li>
							<li class="ng-scope">
								<span class="checkbox">
								...
								<a href="javascript:" class="btn_link">[상세보기]</a>
								<div class="ly_terms ng-hide" id="termDetail0" style="top: 5px; left: 210px;">
									<button type="button" class="btn_close" style="cursor: pointer;">
				...
				<div class="reserve_right right_type_2">
					<dl class="sports_info right_lst3 ng-scope">
						<dt class="img_title">
							<em class="img_bx"> <img src="${ctp}/images/sports/emblem/${homeTeamShorName}.png" alt="${homeTeamShorName}">
							</em>
							<span class="versus sp_sports">vs</span>
							<em class="img_bx"> <img src="${ctp}/images/sports/emblem/${awayTeamShorName}.png" alt="${awayTeamShorName}">
							</em>
						</dt>
