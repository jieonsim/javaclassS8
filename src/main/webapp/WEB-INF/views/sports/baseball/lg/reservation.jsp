										...
										<c:otherwise>
											<ul>
												<c:forEach var="game" items="${games}">
													<li class="_game_list" gamedate="${game.gameDate}" gametime="${game.gameTime}" bookingopendaysbefore="${game.bookingOpenDaysBefore}" bookingopentime="${game.bookingOpenTime}" bookingcloseminutesafterstart="${game.bookingCloseMinutesAfterStart}" data-game-id="${game.id}" data-game-id="${game.id}">
