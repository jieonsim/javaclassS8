		...
		<div class="inner">
			...
			<div class="help_cont">
				...
				<div class="help_rcont">
					...
					<ul class="mypage_tab">
						<li ng-class="{'on': search.state.name === stateType['PARTIALLY_COMPLETE'] }" ng-click="fn.toggleReserveType(stateType['PARTIALLY_COMPLETE'])">
							<a href="#">예매확인</a>
						</li>
						<li ng-class="{'on': search.state.name === stateType['ALL_CANCEL'] }" ng-click="fn.toggleReserveType(stateType['ALL_CANCEL'])" class="on">
							<a href="#">예매취소</a>
						</li>
					</ul>
					<div class="sortbx">
							...
							<tbody>
								...
								<tr ng-repeat="reserve in reserveList" ng-show="reserveList.length > 0" class="ng-scope">
									<td class="fs12 number">
										<a href="/my/reserve/1468853619" class="point_number ng-binding"> 1468853619 </a>
									</td>
									<!-- ngIf: reserve.productDetailInfoExposureYn == 'N' -->
									...
									<!-- end ngIf: reserve.productDetailInfoExposureYn == 'N' -->
									<!-- ngIf: reserve.productDetailInfoExposureYn == 'Y' -->
									<td class="fs12 number ng-binding">2024.07.30(화) 18:30</td>
									<td class="ng-binding">3장</td>
									<td class="fs12 number color_point ng-binding">2024.07.30 14:30</td>
									<td>
										...
										<div class="reserve_condition2 ng-binding" ng-show="reserve.cancelDatetime != null">2024.07.27</div>
										<div class="reserve_condition2 ng-hide" ng-show="reserve.cancelDatetime == null">
								...
								<tr ng-repeat="reserve in reserveList" ng-show="reserveList.length > 0" class="ng-scope">
									<td class="fs12 number">
										<a href="/my/reserve/1466662907" class="point_number ng-binding"> 1466662907 </a>
									</td>
									<!-- ngIf: reserve.productDetailInfoExposureYn == 'N' -->
									<td class="tl ng-scope" ng-if="reserve.productDetailInfoExposureYn == 'N'">
										<!-- ngIf: reserve.displayProductType === 'SPORTS_PRODUCT_NAME' -->
										...
										<span class="elp ng-scope" ng-if="reserve.displayProductType === 'SPORTS_TEAM_MATCH'">
											...
											<!-- end ngIf: reserve.leagueName -->
											<!-- ngIf: reserve.gameTitle -->
											<span ng-if="reserve.gameTitle" class="ng-binding ng-scope">
												1구간
												<br>
											</span>
											<!-- end ngIf: reserve.gameTitle -->
											<!-- ngIf: reserve.teamMatchUseYn === 'Y' -->
											<span ng-if="reserve.teamMatchUseYn === 'Y'" class="ng-binding ng-scope">한화이글스 vs kt wiz</span>
											<!-- end ngIf: reserve.teamMatchUseYn === 'Y' -->
										</span>
										<!-- end ngIf: reserve.displayProductType === 'SPORTS_TEAM_MATCH' -->
										<!-- ngIf: reserve.displayProductType === 'DEFAULT_PRODUCT_NAME' -->
									...
									<!-- end ngIf: reserve.productDetailInfoExposureYn == 'N' -->
									<!-- ngIf: reserve.productDetailInfoExposureYn == 'Y' -->
									<td class="fs12 number ng-binding">2024.07.04(목) 18:30</td>
									<td class="ng-binding">1장</td>
									<td class="fs12 number color_point ng-binding">2024.07.04 16:30</td>
									<td>
										<div class="reserve_condition1 ng-binding">
											전체취소
											<span ng-show="reserve.cancelReason != null &amp;&amp; reserve.cancelReason.isFrontExposable" class="ng-binding ng-hide"> () </span>
										</div>
										<div class="reserve_condition2 ng-binding" ng-show="reserve.cancelDatetime != null">2024.07.01</div>
										<div class="reserve_condition2 ng-hide" ng-show="reserve.cancelDatetime == null">
											<a href="javascript:;" class="btn btn_blank ng-hide" ng-show="reserve.reserveStateCode.name == 'WAIT'" ng-click="fn.common.openAccount(reserve.reserveNo)">입금안내</a>
											<a href="javascript:;" class="btn btn_blank ng-hide" ng-show="reserve.reserveStateCode.name == 'RAIN_CANCEL'">환불계좌</a>
										</div>
