...
<body>
			...
			<div class="help_cont">
				...
				<div class="help_rcont ng-scope">
								...
								<tr>
									...
									<td>
										<c:forEach items="${reservationDetails}" var="detail">
											<p class="ng-binding ng-scope">${detail.seatName}&nbsp;${detail.seatBlock}블럭&nbsp;${detail.seatRow}열&nbsp;${detail.seatNumber}번<span class="ng-binding">(취소)</span>
											</p>
										</c:forEach>
									</td>
					...
					<div class="list_btn ng-scope">
						<a href="${ctp}/my/reserve/cancel/print?reserveId=${reservation.id}" class="btn btn_full" id="printPopupBtn">프린트</a>
					</div>
							...
							<tbody style="font-family: 'Pretendard-Regular'">
								<c:forEach items="${reservationDetails}" var="detail" varStatus="status">
									<tr class="ng-scope">
										...
										<td class="color_point font_option ng-scope">${reservation.status}</td>
					...
					<h5 class="mgt40 text_tit ng-scope">환불정보</h5>
					<div class="basic_tbl_v4 ng-scope">
						<table>
							<caption>
								<span class="blind">환불정보</span>
							</caption>
							<colgroup>
							...
							<tfoot>
								<tr class="final final_option">
									...
									<td colspan="3">
										<span class="color_point">
											<span class="number">
												<span class="number ng-binding"><fmt:formatNumber value="${cancelInfo.refundAmount}" type="number" />원</span>
											</span>
										</span>
									</td>
								</tr>
							...
							<tbody>
								<tr class="line">
									<th scope="row" class="lspacingm1">티켓금액</th>
									<td class="tr ng-binding"><fmt:formatNumber value="${cancelInfo.totalTicketPrice}" type="number" />원</td>
									<th scope="row" class="lspacingm1">예매수수료
								...
								<tr>
									<th scope="row" class="lspacingm1">
										...
										<div class="layer_mother">
											<a class="help">도움말보기</a>
											<div class="layer only_txt" style="width: 220px; left: 22px; top: 3px">
												<p class="layer_text">예매 익일부터 티켓 취소 시 장당 10% 부과되는 취소수수료 입니다.</p>
											</div>
										</div>
									</th>
	...
	<script src="${ctp}/js/my/reserve/cancel/cancelDetail.js"></script>
</body>
</html>