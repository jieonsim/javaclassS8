	...
	<div class="footer_inner container p-4">
		...
		<address class="footer_address mt-2">
			<p style="margin-bottom: 0px;">
				<span class="footer_address_item d-inline-block">주소: 06043
					서울특별시 강남구 강남대로 586, 제이빌딩</span>
		...
		<span class="footer_copyright d-block mt-3">Copyright © NHN
			LINK Corporation. All rights reserved.</span>
