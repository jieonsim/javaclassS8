	...
	<div class="memberContainer">
		<div class="header">
			<div class="headerInner">
				...
				<div class="headerTitle">가입완료</div>
			</div>
		</div>
		<div class="contents">
			<div class="contentWrapper registContent">
				<div class="text-center">
					<div class="celebration-icon">
						<img alt="축하아이콘" src="${ctp}/images/member/signup/celebration.png">
					</div>
					<div class="complete-text">
						<p id="completeText1">티켓챔프 회원가입이 완료되었습니다.</p>
						<p id="completeText2">로그인 후 티켓챔프의 다양한 서비스를 이용하실 수 있습니다.</p>
					</div>
				</div>
				<div>
					<div class="ubtnArea">
						<div class="col">
							<button type="button" class="uBtn point" onclick="location.href='${ctp}/login';">로그인 하러가기</button>
						</div>
					</div>
				</div>
			</div>
