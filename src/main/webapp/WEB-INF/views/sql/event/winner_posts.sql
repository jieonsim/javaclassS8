...
CREATE TABLE winner_posts (
    ...
    title VARCHAR(255) NOT NULL COMMONET '게시글 제목',
    content TEXT NOT NULL COMMONET '게시글 내용',
    createdAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '게시글 업로드 일시',
    updatedAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '게시글 업로드 수정 일시'
    PRIMARY KEY (id),
