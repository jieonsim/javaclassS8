...
CREATE TABLE reservations (
    ...
    reservationNumber CHAR(10) NOT NULL COMMENT '예매번호',
...
CREATE TABLE reservation_details (
    ...
    seatId INT NOT NULL COMMENT '좌석 등급 고유번호',
    ticketTypeId INT NOT NULL COMMENT '권종 고유번호',
    seatBlock INT NOT NULL COMMENT '좌석 블럭',  -- 101~109 사이의 블록 번호
    seatRow INT NOT NULL COMMENT '좌석 열',    -- 1~10 사이의 열 번호
    seatNumber INT NOT NULL COMMENT '권종별 티켓 요금', -- 1~99 사이의 좌석 번호
