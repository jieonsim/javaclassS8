document.addEventListener('DOMContentLoaded', function() {
	...
	function addNewTicketToList(newTicket, ticketTypeId) {
		...
		//addCheckboxEventListener(newRow.querySelector('input[type="checkbox"]'), parseInt(document.querySelector('.select._price_cnt').textContent, 10));
	...
	function renderAdvanceTickets(ticketTypeId, selectedQuantity) {
		...
		/*document.querySelectorAll(`#coupon${ticketTypeId} input[type="checkbox"]`).forEach(function(checkbox) {
