...
@Data
public class ReservationResponse2 {
    ...
    // 기본 생성자
    public ReservationResponse2() {}

    // 모든 필드를 초기화하는 생성자
    public ReservationResponse2(boolean success, String reservationNumber, String message, 
    ...
    public ReservationResponse2(String reservationNumber, String message) {
