...
public interface SearchService {
	...
	Map<String, Object> sendPasswordCertification(String name, String email) throws MessagingException;

	// 비밀번호 찾기 - 인증번호 일치여부 확인
	Map<String, Object> verifyPasswordCertification(String name, String email, String certificationNumber);
