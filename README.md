...
| **기능 구분** | **세부 기능** |
|:---------------:|---------------|
| **회원**   | - 회원가입 및 로그인 <br> - 아이 / 비밀번호 찾기 <br> - 마이페이지 <ul><li>예매 내역 조회 및 취소</li><li>예매권 관리 (등록/사용 내역)</li><li>이벤트 참여 내역</li><li>회원정보 수정</li><li>회원탈퇴</li></ul>  |
...
| **어드민** | - 스포츠/구단/경기장/좌석/요금/경기 관리 <br> - 회원 관리 <br> - 이벤트 관리 <br> - 예매권 관리 <br> - 통계 대시보드(차트 기) |
